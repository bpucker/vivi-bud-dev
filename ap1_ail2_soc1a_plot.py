...
def plot_expression( exp_data, genes, result_file, day_lengths ):
	...
	name_mapping = { 'VIT_201s0011g00100': 'VviAP1', 'VIT_209s0002g01370': 'VviAIL2', 'VIT_215s0048g01250': 'SOC1a' }
	patches = []
	...
	fig.subplots_adjust( left=0.075, right=0.94, top=0.99, bottom=0.15 ) 
...
def main(arguments):
	...
	result_file = directory + "VviAP1_VviAIL2_SOC1a_expression.jpg"
